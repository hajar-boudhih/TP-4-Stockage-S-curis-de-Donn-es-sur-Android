...
public class LoginActivity extends AppCompatActivity {
                ...
                if (user != null) {
                    ...
                    if (passwordValid) {
                        runOnUiThread(() -> {
                            ...
                            // Ouverture de l'activité principale (ou NotesActivity)
                        ...
                        runOnUiThread(() -> Toast.makeText(LoginActivity.this, "Mot de passe incorrect", Toast.LENGTH_SHORT).show());
                    }
                } else {
                    runOnUiThread(() -> Toast.makeText(LoginActivity.this, "Utilisateur non trouvé", Toast.LENGTH_SHORT).show());
                }
            }
            
            @Override
            public void onError(Exception e) {
                runOnUiThread(() -> Toast.makeText(LoginActivity.this, "Erreur lors de la connexion: " + e.getMessage(), Toast.LENGTH_SHORT).show());
            }
        });
    }
    ...
    private void register() {
        ...
        databaseManager.insertUser(user, new DatabaseManager.DatabaseCallback<Long>() {
            ...
            @Override
            public void onError(Exception e) {
                runOnUiThread(() -> Toast.makeText(LoginActivity.this, "Erreur lors de l'inscription: " + e.getMessage(), Toast.LENGTH_SHORT).show());
            }
        });
    }
}
